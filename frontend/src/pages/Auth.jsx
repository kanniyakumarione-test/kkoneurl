    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        <div className="card !p-8 shadow-2xl border-white/5">
          <h2 className="text-2xl font-black font-display mb-2 text-center">Welcome to kkoneurl</h2>
          <p className="text-white/40 text-sm mb-8 text-center">Sign in to manage your premium short links</p>

          <button 
            onClick={handleGoogleLogin}
            disabled={loading}
            className={`btn btn-primary w-full !py-4 !rounded-2xl shadow-glow flex items-center justify-center gap-3 ${loading ? 'opacity-50' : ''}`}
          >
            {loading ? (
              'Authenticating...'
            ) : (
          ...
          <p className="text-center text-[10px] text-white/20 uppercase tracking-widest font-black">
